...
setting_26 = Setting.find_or_create_by!(name: 'birthday_discount_percentage', data_type: 'type_integer', internal: false, localized_name: '% de descuento cumpleañero', string_value: nil, integer_value: 30, float_value: nil, datetime_value: nil, boolean_value: true, hash_value: nil, status: 'active')
...
setting_33 = Setting.find_or_create_by!(name: 'feature_flag_uom', data_type: 'type_boolean', internal: false, localized_name: 'Unidades de Medida', string_value: nil, integer_value: nil, float_value: nil, datetime_value: nil, boolean_value: false, hash_value: nil, status: 'active')
...
Services::Products::InitialStockImportService.new("chacarilla_st_22_nov_2024.csv", 1, "Chacarilla").import_individual_stock_transfer
